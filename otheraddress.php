...
<html lang="en">
<head>
  <title>New Address - Agenda</title>
...
<div class="container">
  <div class="row">
    <div class="col-sm-12 rounded" style="background-color:#f5f5f5; border:solid 1px #eeeeee; margin: 0 auto;">
       <form id="addr" name="addr" method="post" action=""  onSubmit="return newAddress(this);">
          <input type="hidden" id="iduser" name="iduser" value="5">
          <br>
          <h4><img src="img/cont_icon.png" style="width:45px; height:45px; " title="Agenda Online"/> Add a new address</h4> 
